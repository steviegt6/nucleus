...
const addonHandler_1 = __importDefault(require("./addons/addonHandler"));
(0, addonHandler_1.default)();
try {
...
if (global.oaConfig.supportsAcrylic !== true || process.platform !== "win32" || (global.oaConfig.acrylicWindow !== true && !((_b = (_a = process.argv) === null || _a === void 0 ? void 0 : _a.includes) === null || _b === void 0 ? void 0 : _b.call(_a, "--acrylic-window")))) {
...
if (process.platform === "win32")
    try {
        for (const m of require("fs").readdirSync(b))
            M.globalPaths.push(join(b, m)); // For each module dir, add to globalPaths
    }
    catch (_c) {
